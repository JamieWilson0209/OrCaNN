#!/bin/bash
# =============================================================================
# One-time environment setup on an HPC cluster. Run from the repo root on a login node:
...
# cu121 is the safe default for recent datacenter GPUs; verify with jobs/check_gpu.sh and
